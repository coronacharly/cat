...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cat12
```

A live public deployment of this template is available at [https://cat12.templates.workers.dev](https://cat12.templates.workers.dev)
